...
type SharedInformerFactory interface {
	...
	Eventhorizon() eventhorizon.Interface
}

func (f *sharedInformerFactory) Eventhorizon() eventhorizon.Interface {
	return eventhorizon.New(f, f.namespace, f.tweakListOptions)
}
